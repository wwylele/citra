...
Loader::ResultStatus NCCHContainer::Load() {
    ...
    if (file.IsOpen()) {
        ...
        if (ncch_header.extended_header_size) {
            ...
            if ((exheader_header.arm11_system_local_caps.program_id & 0xFFFFFFFF) != (ncch_header.program_id & 0xFFFFFFFF)) {
                ...
                dec.ProcessData((CryptoPP::byte*)&exheader_header, (CryptoPP::byte*)&exheader_header,
                                sizeof(exheader_header));
