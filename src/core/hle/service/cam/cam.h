...
/**
 * Resulition parameters for the camera.
...
static_assert(sizeof(PackageParameterWithoutContext) == 28,
              "PackageParameterCameraWithContext structure size is wrong");
...
/**
 * Start the select ports capturing.
 *  Inputs:
 *      0: 0x00010040
 *      1: u8 port select
 *  Outputs:
...
/**
 * Stops the select ports capturing.
 *  Inputs:
 *      0: 0x00020040
 *      1: u8 port select
 *  Outputs:
...
/**
 * Gets whether the select port is currently capturing.
 *  Inputs:
 *      0: 0x00030040
 *      1: u8 port select
 *  Outputs:
...
/**
 * Clears the buffer of select ports.
 *  Inputs:
 *      0: 0x00040040
 *      1: u8 port select
 *  Outputs:
...
/**
 * Gets the event associated with V-Sync interrupts of the select port.
 *  Inputs:
 *      0: 0x00050040
 *      1: u8 port select
 *  Outputs:
...
/**
 * Gets the event associated with buffer error interrupts of the select port.
 *  Inputs:
 *      0: 0x00060040
 *      1: u8 port select
 *  Outputs:
...
/**
 * Gets whether the select port finished receiving a frame.
 *  Inputs:
 *      0: 0x00080040
 *      1: u8 port select
 *  Outputs:
...
/**
 * Sets the number of lines to transfer in each turn.
 *  Inputs:
 *      0: 0x00090100
 *      1: u8 port select
...
/**
 * Sets the number of bytes to transfer in each turn.
 *  Inputs:
 *      0: 0x000B0100
 *      1: u8 port select
...
/**
 * Gets the number of bytes to transfer in each turn.
 *  Inputs:
 *      0: 0x000C0040
 *      1: u8 port select
 *  Outputs:
 *      0: 0x000C0080
 *      1: ResultCode
 *      2: The number of bytes to transfer in each turn.
 */
...
/**
 * Sets camera resolution from custom parameters. For more details see struct Resolution.
 *  Inputs:
 *      0: 0x001E0200
 *      1: u8 camera select
 *      2: width
...
/**
 * Sets camera resolution from library.
 *  Inputs:
 *      0: 0x001F00C0
 *      1: u8 camera select
 ...
 *  Inputs:
 *      0: 0x00290080
 *      1: u8 camera select 1
 *      2: u8 camera select 2
 *  Outputs:
 *      0: 0x00280040
 *      1: ResultCode
 */
...
/**
 * Batch-configures context-related settings with resolition from labrary
 *
 *  Inputs:
 *      0: 0x00340140
